...
public class Inventory : MonoBehaviour
{
    ...
    */
    ...
    public TextMeshProUGUI Description_Text; // 부연 설명
    ...
    void Start()
    {
        ...
        inventoryItemList.Add(new Item(20001, "가죽 모자", "가죽으로 된 모자, 나름 질기고 감기는 맛이 있다.", Item.ItemType.Equip));
        inventoryItemList.Add(new Item(30001, "가죽 옷", "가죽으로 된 옷, 구식이지만 나름 센스있다.", Item.ItemType.Equip));
        inventoryItemList.Add(new Item(40001, "가죽 신발", "가죽으로 된 신발, 잘 찢어지지만 나름의 감성이 있다.", Item.ItemType.Equip));
        inventoryItemList.Add(new Item(50001, "나무 반지", "나무로 만든 반지, 투박하지만 나름 이쁜데?", Item.ItemType.Equip));

        // 재료형 아이템
        inventoryItemList.Add(new Item(11001, "목재", "가공된 목재, 다양한 곳에 활용할 수 있어보인다", Item.ItemType.ETC, 9));
